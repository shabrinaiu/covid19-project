        ...
        <div class="col-lg-9">
            <div class="card">
                ...
                <div class="card-body text-justify">
                    ...
                    <div>
                        Perkembangan data pandemi covid-19 di Indonesia, telah merenggut 181 nyawa pada 3 April 2020 (sumber :  <a href="covid19.bnpb.go.id">http://covid19.bnpb.go.id/)</a> dan merupakan ancaman besar bagi kesehatan masyarakat global khususnya Indonesia. Karena pandemi COVID-19 berlaku di seluruh dunia, maka kita bisa melihat perilaku masyarakat dan kebijakan pemerintah di seluruh dunia yang mempunyai kemiripan dengan Indonesia untuk dipakai dalam penentuan parameter dalam model yang tepat.
                    </div>
                    <div>
