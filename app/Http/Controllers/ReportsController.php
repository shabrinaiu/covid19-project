...
class ReportsController extends Controller
{
    ...
    public function processComparedData(Request $request)
    {
        ...
        return view('pages.reports.comparison', compact([
    ...
    public function processAllCountries(Request $request)
    {
        ...
        return view('pages.reports.comparison-all', compact([
            'data', 'getComparedHistoryData', 'getMainHistoryData',
    ...
    public function seedCountryDetails(Request $request)
    {
        ...
        foreach ($queryCountries as $i => $country) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://api.covid19api.com/country/" . $country->slug .
                    '?from=' . $request->date_start . '&to=' . $date_end,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_TIMEOUT => 30,
                CURLOPT_SSL_VERIFYHOST => 0,
        ...
        return response()->json([
            'success' => true,
            'message' => 'Country details has stored'
        ], 200);
    }
}
